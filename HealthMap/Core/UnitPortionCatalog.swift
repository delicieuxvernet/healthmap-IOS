...
enum UnitPortionCatalog {
    ...
    private static let definitions: [Definition] = [
        ...
        .init(motif: #"quiches?|tarte (salee|aux legumes|au thon|lorraine|aux poireaux|a l'oignon)|flammekueche|tarte flambee|tourte"#, singulier: "part", pluriel: "parts", grammes: 120, tailles: tailles(contenantF, 90, 120, 180)),
        ...
        .init(motif: #"\btartes?\b|gateaux?|\bcakes?\b|brownie|fondant|moelleux|clafoutis|far breton|quatre-quarts|\bmarbre\b|paris-brest|eclairs?|mille-?feuille|religieuse"#, singulier: "part", pluriel: "parts", grammes: 100, tailles: tailles(contenantF, 70, 100, 150)),
        ...
        .init(motif: #"creme glacee|\bglaces?\b|sorbet"#, singulier: "boule", pluriel: "boules", grammes: 60),
        ...
        .init(motif: #"toasts?|tartines?"#, singulier: "tartine", pluriel: "tartines", grammes: 40),
        ...
        .init(motif: #"gaufres?"#, singulier: "gaufre", pluriel: "gaufres", grammes: 60),
        ...
        .init(motif: #"macarons?"#, singulier: "macaron", pluriel: "macarons", grammes: 15),
        ...
        .init(motif: #"camembert|\bbrie\b|coulommiers|\bbleu\b|roquefort|fourme|gorgonzola|chevre|comte|emmental|gruyere|beaufort|gouda|edam|cheddar|mimolette|cantal|reblochon|tomme|raclette|morbier|saint-nectaire|munster|parmesan|mozzarella|\bfeta\b|ricotta|mascarpone|boursin|saint-moret|\bfromages?\b"#, singulier: "part", pluriel: "parts", grammes: 30, tailles: tailles(contenantF, 20, 30, 45)),
